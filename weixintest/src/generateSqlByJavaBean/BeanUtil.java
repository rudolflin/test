...
public class BeanUtil {  
    ...
    public static void main(String[] args) {  
        ...
        System.out.println(getBeanFilesList("User"));  
          
        System.out.println(genCreateTableSql("User"));  
//          
        System.out.println(genInsertSql("generateSqlByJavaBean"));  
    }  
